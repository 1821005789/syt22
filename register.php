                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group"><br><br>
                            ...
                            <input type="text" name="name" class="form-control <?php echo (!empty($name_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $name; ?>"><br>
                            <span class="invalid-feedback"><?php echo $name_err;?></span><br>
                        </div>
                        <div class="form-group">
                            <label for="fname">address</label>
                            <input type="text" name="address622" class="form-control <?php echo (!empty($address622_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $address622; ?>"><br>
                            <span class="invalid-feedback"><?php echo $address622_err;?></span><br>
                        </div>
                        <div class="form-group">
                            <label for="fname">Salary</label>
                            <input type="text" name="salary" class="form-control <?php echo (!empty($salary_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $salary; ?>"><br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>"><br>
